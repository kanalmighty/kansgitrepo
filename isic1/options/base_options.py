...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.argument_parser.add_argument('--network', type=str, help='choices including vgg16,vgg19,alexnet,inception,resnet18,densenet161', choices=['vgg16', 'vgg19', 'alexnet', 'inception', 'resnet18', 'googlenet', 'densenet161', 'resnet50', 'resnet34', 'efficientnet-b0', 'efficientnet-b1', 'efficientnet-b2',  'efficientnet-b3', 'efficientnet-b4', 'efficientnet-b5', 'efficientnet-b6', 'efficientnet-b7', 'wres_attention'])
