...
from models.attention.attention import AttentionModule, Gate
...
class WideResNetAttention(torch.nn.Module):
    ...
    def __init__(self, depth, width, num_classes, dropout, attention_depth, attention_width, reg_w=0,
        ...
        Args:
            ...
            dropout: dropout prob
            attention_depth: number of attention models
    ...
    def forward(self, x):
        ...
        group2 = F.relu(self.bn_g2(self.group_2(group1)), True)#2,128,32,32
        ...
        o = F.avg_pool2d(group2, 8, 1, 0)#o.shape 2 128 25 25
        o = o.view(o.size(0), -1)#o的size 和gates的size对不上
