...
class YoloDataset(Dataset):
    ...
    def get_random_data_with_Mosaic(self, annotation_line, input_shape, hue=.1, sat=1.5, val=1.5):
        ...
        place_x = [0, 0, int(w * min_offset_x), int(w * min_offset_x)]#[0,0,124,124]
        place_y = [0, int(h * min_offset_y), int(w * min_offset_y), 0]#[0,124,124,0]
        #annotation_line有四张图片
