...
import kansgitrepo.myimplemention.dcgan.dcgansettings as settings
...
datasets = datasets.cifar(root='D:\\pycharmspace\\cifar\\',
...
#         output = netD(fake.detach()).view(-1)#更新前判别器对假数据的检测结果
...
#         errG.backward()
#         D_G_z2 = output.mean().item()#更新后的判别器对假数据的检测结果
#         # Update G
#         optimizerG.step()
#
#
